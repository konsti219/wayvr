  ...
  outputs = {
    ...
    flake-utils.lib.eachSystem ["x86_64-linux" "aarch64-linux"] (system: let
      ...
      wivrn = pkgs.wivrn.overrideAttrs (finalAttrs: oldAttrs: {
        ...
        # WiVRn's GitVersion.cmake requires GIT_COMMIT at build time, which
        # can't be inferred from the (gitless) nix source. v26.9 tag commit:
        cmakeFlags =
          (oldAttrs.cmakeFlags or [])
          ++ [
            "-DGIT_COMMIT=bbc6e4cc36c355fa6180980abd231673dc15115d"
          ];
        ...
        # Monado source revision pinned by WiVRn v26.9 (see its monado-rev file),
        ...
        monado = pkgs.applyPatches {
          ...
          # monado revision shipped by WiVRn 26.9 (XRT_ERROR_OUT_OF_MEMORY moved
